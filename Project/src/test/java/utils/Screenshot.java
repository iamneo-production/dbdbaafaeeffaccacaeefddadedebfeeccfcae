...
public class Screenshot {
    public String captureScreenshot(WebDriver driver, String screenshotName, String relativeScreenshotPath) {
        ...
        // Define the screenshots directory path
        String screenshotsDirectory = System.getProperty("user.dir") + "/" + relativeScreenshotPath;
