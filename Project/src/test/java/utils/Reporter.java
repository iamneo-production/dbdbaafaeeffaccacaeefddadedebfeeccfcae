...
public class Reporter {
    ...
    public static void logScreenshot(String screenshotPath, String description) {
        try {
            extentReport.createTest(description)
                .fail("Screenshot: " + description, MediaEntityBuilder.createScreenCaptureFromPath(screenshotPath).build());
        } catch (IOException e) {
            e.printStackTrace();
